...
class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    private static final float CENTER_RADIUS = 15.75f; //should add up to 10 when + stroke_width
    private static final float STROKE_WIDTH = 2.5f;
    private static final int DRAWABLE_INSET = 35;

    // Maps to ProgressBar.Large style
    private static final int CIRCLE_DIAMETER_LARGE = 56;
    private static final float CENTER_RADIUS_LARGE = 22.5f;
    private static final float STROKE_WIDTH_LARGE = 3f;
    private static final int DRAWABLE_INSET_LARGE = 50;
