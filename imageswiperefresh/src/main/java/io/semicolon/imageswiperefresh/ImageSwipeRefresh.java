package io.semicolon.imageswiperefresh;
...
/**
 * Created by nasir on 27/12/14.
 */
public class ImageSwipeRefresh extends ViewGroup {
    // Maps to ProgressBar.Large style
    public static final int LARGE = MaterialProgressDrawable.LARGE;
    // Maps to ProgressBar default style
    public static final int DEFAULT = MaterialProgressDrawable.DEFAULT;

    private static final String LOG_TAG = ImageSwipeRefresh.class.getSimpleName();
    ...
    private static final int[] LAYOUT_ATTRS = new int[]{
            ...
            R.styleable.ImageSwipeRefresh_src
    };
     ...
     * @param context
     */
    public ImageSwipeRefresh(Context context) {
        this(context, null);
    }
     ...
     * @param attrs
     */
    public ImageSwipeRefresh(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        setEnabled(true);
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ImageSwipeRefresh);
        mCenterImage = a.getDrawable(R.styleable.ImageSwipeRefresh_src);
        a.recycle();
    ...
    private void createProgressView() {
        mCircleView = new CircleImageView(getContext(), CIRCLE_BG_LIGHT, CIRCLE_DIAMETER / 2, mCenterImage);
    ...
    public void setProgressBackground(int background) {
        mCircleView.setBackgroundResource(background);
    }
